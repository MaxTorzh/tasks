package ru.yandex.practicum.objPractise.booking;

import ru.yandex.practicum.codingpractice.model.BedAndBreakfast;

import java.util.Scanner; // импортируйте классы BedAndBreakfast и Scanner
