package ru.yandex.practicum.otherFields.enumPractise.recycling;
...
public class Practicum {
    ...
    public static String map = "https://recyclemap.ru/";
    ...
    public static void main(String[] args) {
        ...
        */
        while (true) {
            String commandValue = scanner.nextLine().toUpperCase(); // Приводим к верхнему регистру для удобства сравнения
            try {
                switch (commandValue) {
                    case "MAP":
                ...
                System.out.println("Произошла ошибка ввода. Пожалуйста, попробуйте снова.");
